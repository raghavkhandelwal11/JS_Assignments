...
let employee1 = {
    name: "Raghav", employeeCode: 1, domain: "Technical"
}
...
displayInfo.call(employee1, "Male", 23); // first is always the function calling the function flowwed by the arguments, 
//note: remember arguments passed are comma seperated

displayInfo.call(employee2, "Male", 24);
displayInfo.call(employee3, "Male", 25);



// Apply
displayInfo.apply(employee1, ["Male", 23]);
displayInfo.apply(employee2, ["Male", 24]);
displayInfo.apply(employee3, ["Male", 25]);
...
console.log(developer.prototype); // constructor f
